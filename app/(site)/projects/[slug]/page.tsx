...
import { DisclaimerPlate } from "@/components/projects/DisclaimerPlate";
            ...
            <Container className="bp-section-y flex flex-col gap-14">
                <div className="grid gap-10 lg:grid-cols-[19rem_1fr] lg:items-start">
                    ...
                    >
                        ...
                        {project.disclaimers && project.disclaimers.length > 0 && (
                            <DisclaimerPlate items={project.disclaimers} />
                        )}
