    ...
    return (
        ...
        >
            <div className="max-w-xl space-y-6 text-center">
                <p className="bp-meta text-accent">Something went wrong</p>
                ...
                <p className="text-body-lg text-pretty text-ink-muted">
                    The fault is usually temporary — often an upstream request that timed out. Try
                    again, or head back and keep browsing.
                </p>
                {error.digest && (
                    <p className="font-mono text-sm text-ink-muted">Reference: {error.digest}</p>
                )}
