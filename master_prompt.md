...
Only introduce additional technologies or libraries if they provide meaningful benefits.
...
Database:
- Supabase (only if dynamic features become necessary)
...
The initial version of the portfolio should remain mostly static.

Do not introduce a database unless there is a clear requirement.
...
Business logic should not be mixed with UI whenever possible.
...
What the developer specializes in.

Why someone should continue exploring the portfolio.
...
Skills should be organized by category instead of proficiency bars.
...
Projects are the most important section of the website.
...
GitHub should become the primary source of project information.
...
Aim for high Lighthouse scores.
...
Prefer server-side rendering and static generation whenever appropriate.
...
The final product should represent the quality expected from a professional software developer.

The website itself should serve as evidence of the developer's engineering ability, UI/UX understanding, code quality, and attention to detail.